    ...
    <div class="puzzle">
      <div class="custom-wrapper">
        ...
        <div>
          ...
          <div>
            <span>Ako ne znate kako, molim pogledajte pa ponovite poteze: https://www.youtube.com/watch?v=1Mn2Kb4QQe8</span>
          </div>
        </div>
      </div>
    </div>
...
export default {
  ...
  async beforeCreate() {
    Parse.initialize("MUwFlUc2CqyycEquX47qc5u0t2Q7IxD1DgYZ8Yiv", "fRmrxpw2UZIuHa0qgCpDEakyKIouNhUgQD4WCrYk");
    ...
    .then((data) => {
      console.log(data)
      data.forEach(solver => this.ratingList.push({
